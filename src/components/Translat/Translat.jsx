...
import s from "./translat.module.css";
const Translat = () => {
  ...
  return (
    <div ref={dropdownRef} className={s.dropdownButton}>
      <button
        onClick={toggleMenu}
        className={`${s.translat} ${isOpen ? s.active : ""}`}
      >
        <svg
          width="18"
          height="18"
        ...
        <span className={s.font600}> {t("translat")}</span>
        <svg
          width="12"
          height="6"
          viewBox="0 0 12 6"
      ...
      <div className={`${s.dropdownMenu} ${isOpen ? s.open : ""}`}>
        <button className={s.language} onClick={() => changeLanguage("ru")}>
          RU
        </button>
        <button className={s.language} onClick={() => changeLanguage("en")}>
          EN
        </button>
        <button className={s.language} onClick={() => changeLanguage("en")}>
          ES
