    ...
    <header className={s.header}>
      <div className={s.content}>
          ...
          >
            ...
            />
            <path
              d="M56.6391 9.6513C58.2932 9.6513 59.5873 10.1519 60.5215 11.1531C61.4557 12.1543 61.9227 13.5381 61.9227 15.3045V22.2276H57.6932V15.8295C57.6932 15.1295 57.4961 14.5678 57.1019 14.1446C56.7076 13.7131 56.1848 13.4974 55.5335 13.4974C54.8907 13.4974 54.3679 13.7131 53.9651 14.1446C53.5709 14.5678 53.3738 15.1295 53.3738 15.8295V22.2276H49.1571V4.71848H53.3738V11.3241C54.1879 10.2089 55.2764 9.6513 56.6391 9.6513Z"
              fill="white"
            />
            <path
              d="M72.3908 9.8955H76.6203V22.2276H72.3908V20.8234C71.5681 21.9223 70.4882 22.4718 69.1512 22.4718C67.4971 22.4718 66.1987 21.9752 65.256 20.9821C64.3218 19.9809 63.8547 18.5971 63.8547 16.8308V9.8955H68.0713V16.3057C68.0713 17.0058 68.2685 17.5674 68.6627 17.9907C69.0655 18.414 69.5969 18.6256 70.2568 18.6256C70.8996 18.6256 71.4138 18.414 71.7995 17.9907C72.1937 17.5674 72.3908 17.0058 72.3908 16.3057V9.8955Z"
              fill="white"
            />
            <path
              d="M86.5613 9.6513C87.6412 9.6513 88.6311 9.94027 89.531 10.5182C90.4394 11.0961 91.1508 11.8776 91.665 12.8625C92.1878 13.8393 92.4492 14.9097 92.4492 16.0737C92.4492 17.8401 91.875 19.3501 90.7266 20.6036C89.5867 21.849 88.1983 22.4718 86.5613 22.4718C84.9415 22.4718 83.6774 21.8897 82.7689 20.7257V22.2276H78.5523V4.71848H82.7689V11.3973C83.6774 10.2333 84.9415 9.6513 86.5613 9.6513ZM85.5586 18.65C86.3214 18.65 86.9727 18.4018 87.5126 17.9052C88.0526 17.4005 88.3226 16.7901 88.3226 16.0737C88.3226 15.3493 88.0526 14.7388 87.5126 14.2422C86.9813 13.7457 86.3299 13.4974 85.5586 13.4974C84.7787 13.4974 84.1188 13.7457 83.5788 14.2422C83.0389 14.7388 82.7689 15.3493 82.7689 16.0737C82.7689 16.7901 83.0389 17.4005 83.5788 17.9052C84.1188 18.4018 84.7787 18.65 85.5586 18.65Z"
              fill="white"
            />
          </svg>
          <svg
